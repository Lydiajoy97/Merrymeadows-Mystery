...
def find_the_major():
     ...
     if thought.lower().strip() == "y":
          ...
          if second_thought.lower().strip() == "y":
               ...
               typewriter('"I do not want to cause any drama, but you should probably talk to her husband.\
                He was pretty angry after finding out Lady Amara and I....Nevermind! Ignore me!"\n')
