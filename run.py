...
def find_the_major():
    ...
    if thought.lower().strip() == "n":
        typewriter('"Look, I will not comment on this without my lawer present. '
...
def find_count_crispin():
    ...
    if count_question.lower().strip() == "y":
        ...
        if second.lower().strip() == "n":
            ...
            'Maybe it was a crime of passion?...I will add Count Chrispin to the '
            'list of suspects...')
            suspects.append("Count Chrispin")
            recall_suspects()
...
def finale():
    ...
    if guilty == "clara":
        ...
        'She is such a public figure, she was not reported any where near '
        'her mums tent.')
