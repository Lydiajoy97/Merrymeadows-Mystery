...
# List of suspects that user will add to and recall at the end.
suspects = []
...
def game_start():
    typewriter('"Tickets please... Tickets.. Hi, thank you..Oh! Hello, you '
               'must be new! Welcome to Merrymeadows funfair. My name is '
...
def first_location():
    ...
    typewriter('Amidst the radiant sunbeams that bathed the vibrant medieval '
               'fairgrounds of MerryMeadow, the joyful atmosphere of the '
               'fair seemed unbreakable.\n Colorful pennants fluttered '
               'merrily in the breeze, mingling with the tantalizing aroma of '
               'caramelized apples and freshly spun cotton candy.\n '
               'Laughter and music filled the air, and chatter echoed across '
               'the bustling fair. But hidden beneath the facade of delight, '
               'a dark shadow had cast its spell over the festivities. \n'
               'Lady Amara, beloved by all the folk of Merrymeadow, had been '
               'discovered dead within her regal tent, her crown askew and a '
...
# first suspect Clara
def find_clara():
    typewriter('Heading to Claras house...\n')
...
# questions for Clara
    if question_answer.lower().strip() == "where":
        typewriter('"Well Obviously I was at the funfair... like the rest of '
                   'the town silly! I was going to meet my mother... '
                   'she said I can go on all the rides with her and use up '
                   'my allowence. The sad thing is I now have no mother and a '
                   'huge allowence."\n')
...
def find_the_major():
    ...
    if thought.lower().strip() == "y":
        typewriter('"Ha! I was at the funfair... and she was fine when I '
                   'saw her... I mean...The day before, we ran though the '
                   'finaces!"\n')
        ...
        if second_thought.lower().strip() == "y":
            ...
            typewriter('"Alright! Fine! I was with her that morning... were '
                       'having an affiar, but we had ended it. She was going '
                       'to tell her husband! Count Chrispin is my friend you '
                       'see... And when he saw us. Oh, I have shared to much. '
                       'Please do not say a word! My reputation is on the '
                       'line."\n')
        ...
        if second_thought.lower().strip() == "n":
            typewriter('"I do not want to cause any drama, but you should '
                       'probably talk to her husband. He was pretty angry '
                       'after finding out Lady Amara and I....Nevermind! '
                       'Ignore me!"\n')
    ...
    if thought.lower().strip() == "n":
        typewriter('"Look, I will not comment on this without my lawer '
                   'present. Please leave. If I were you I would talk to the '
                   'husband."')
        print("Adding the Major to list of suspects...")
        suspects.append("The Major")
        print("Going to find Count Chrispin...")
...
def find_count_crispin():
    ...
    if count_question.lower().strip() == "y":
        typewriter('"I can not believe you would be this insenstive. '
                   'I was with my wife. Until... Until...that man decided '
                   '...decided to surprise her with breakfast in the tent. '
                   'That is when I found out about the affair. They were '
                   'already there enjoying their pancakes."\n')
        ...
        if second.lower().strip() == "y":
            ...
            typewriter('"Of course I got angry. Anyone would! I still am. '
                       'That was my wife! I dont remember much about that '
                       'morning. I stormed off after I found them."')
        ...
        if second.lower().strip() == "n":
            ...
            typewriter('hmmm, if that were me I would get pretty angry. '
                       'Maybe it was a crime of passion?...I will add Count '
                       'Chrispin to the list of suspects...')
            suspects.append("Count Chrispin")
            recall_suspects()
    ...
    if count_question.lower().strip() == "n":
        typewriter('"You know, what I like about you is that you '
                   ...
                   'I wish none of this happened. I wish I had not walked '
                   'in on them... I wish she was here."')
        typewriter('"I better get going. You have a lot on your plate."\n')
        print('"hmmm, them? Maybe it was a crime of passion?... '
              'I will add Count Chrispin to my list of suspects..."\n')
        suspects.append("Count Chrispin")
        recall_suspects()
...
def finale():
    ...
    if guilty == "count chrispin":
        typewriter('But Count Chrispin was not the last to see Lady Amara, '
                   'he stormed off. It can not have been him.')
    if guilty == "clara":
        typewriter('Clara was seen by a lot of people at the funfair. '
                   'She is such a public figure, she was not reported '
                   'any where near her mums tent.')
    typewriter('The Major was charged for the murder of Lady Amara. '
               'Traces of poison were found in the autopsy. '
               'A letter addressed to Count Chrispin was found on the '
               'corpse.\n')
    typewriter('"To my dearest Carter, I have to come clean to you, my '
               'husband. Our secret is killing me. I have been having an '
               'affair with the major. I am sorry amd I will love you '
               'always."\n')
